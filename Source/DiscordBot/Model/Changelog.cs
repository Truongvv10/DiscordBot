    ...
    public class Changelog {
        ...
        public void AddChangelog(string title, string description) {
            if (!string.IsNullOrWhiteSpace(title) && !string.IsNullOrWhiteSpace(description)) {
                _version = IncrementVersion(_version, VersionType.MINOR);
        ...
        public Changelog UpdateChangelog() {
            ...
            _changes.Clear();
            _version = IncrementVersion(_version, VersionType.MAJOR);
            return changelog;
        }
        ...
        private string IncrementVersion(string version, VersionType versionType) {
            ...
            if (versionType == VersionType.MAJOR) major++;
            if (versionType == VersionType.MINOR) minor++;
            return $"{major}.{minor}";
        }
        #endregion
    }
