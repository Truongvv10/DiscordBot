                ...
                foreach (var option in options) {
                    switch (option) {
                        ...
                        case Identity.SELECTION_CONTENT:
                            ...
                            modal.AddComponents(new TextInputComponent(option, Identity.MODAL_COMP_CONTENT, text, embed.Content, false, TextInputStyle.Paragraph));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;
                        ...
                        case Identity.SELECTION_PINGROLE:
                            ...
                            modal.AddComponents(new TextInputComponent($"ROLES", Identity.MODAL_COMP_PINGROLE, roleId, string.Join(", ", embed.PingRoles), true, TextInputStyle.Paragraph));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;
                        ...
                        case Identity.SELECTION_FIELD_ADD:
                            ...
                            modal.AddComponents(new TextInputComponent("TITLE", Identity.MODAL_COMP_FIELD_TITLE, text, null, false, TextInputStyle.Short));
                            modal.AddComponents(new TextInputComponent("TEXT", Identity.MODAL_COMP_FIELD_TEXT, text, null, false, TextInputStyle.Paragraph));
                            modal.AddComponents(new TextInputComponent("INLINE", Identity.MODAL_COMP_FIELD_INLINE, "True or False", "True", false, TextInputStyle.Short));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;
                        case Identity.SELECTION_FIELD_REMOVE:
                            if (embed.Fields.Count() != 0) {
                                ...
                                modal.AddComponents(new TextInputComponent("INDEX", Identity.MODAL_COMP_FIELD_INDEX, $"Number from 0 to {embed.Fields.Count() - 1}", null, true, TextInputStyle.Short, 1, 2));
                                await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            }
                            break;
                        default:
                ...
                foreach (var option in options) {
                    switch (option) {
                        ...
                        case Identity.SELECTION_TEMPLATE_USE:
                            var templateUseEmbed = await CacheData.GetTemplate(e.Interaction.Guild.Id, Identity.TDATA_USE);
                            using (StreamReader sr = new StreamReader(Path.Combine(Environment.CurrentDirectory, "Saves", "Templates.json"))) {
                                ...
                                templateUseEmbed.Description = templateUseEmbed.Description!.Replace($"{{{Identity.TEMPLATE_LIST}}}", json.Keys.Aggregate("", (current, next) => current + "\n- `" + next + "`"));
                            }
                            ...
                            await DiscordUtil.CreateMessageAsync(CommandEnum.TEMPLATE_USE, e.Interaction, templateUseEmbed, e.Interaction.Channel.Id, templateUseEmbed.IsEphemeral);
                            break;
                ...
                foreach (var option in options) {
                    switch (option) {
                        ...
                        case Identity.SELECTION_EVENT_PROPERTIES:
                            ...
                            modal.AddComponents(new TextInputComponent("EVENT NAME", Identity.EVENT_NAME, "Amongus", embed.CustomData[Identity.EVENT_NAME] as string, true, TextInputStyle.Short));
                        ...
                        case Identity.SELECTION_EVENT_INTRODUCTION:
                            ...
                            modal.AddComponents(new TextInputComponent("TITLE", Identity.EVENT_TITLE, text, embed.CustomData[Identity.EVENT_TITLE] as string, true, TextInputStyle.Short, 4, 32));
                            modal.AddComponents(new TextInputComponent("INTRODUCTION", Identity.EVENT_INTRO, text, embed.CustomData[Identity.EVENT_INTRO] as string, true, TextInputStyle.Paragraph, 0, 500));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;
                        ...
                        case Identity.SELECTION_EVENT_INFORMATION:
                            ...
                            modal.AddComponents(new TextInputComponent("TITLE", Identity.EVENT_INFO_TITLE, text, embed.CustomData[Identity.EVENT_INFO_TITLE] as string, true, TextInputStyle.Short, 4, 32));
                            modal.AddComponents(new TextInputComponent("INFORMATION", Identity.EVENT_INFO, text, embed.CustomData[Identity.EVENT_INFO] as string, true, TextInputStyle.Paragraph, 0, 2048));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;

                        case Identity.SELECTION_EVENT_REWARDS:
                            modal.WithTitle("EVENT REWARDS").WithCustomId($"{Identity.MODAL_EVENT};{option};{messageId}");
                            modal.AddComponents(new TextInputComponent("TITLE", Identity.EVENT_REWARD_TITLE, text, embed.CustomData[Identity.EVENT_REWARD_TITLE] as string, true, TextInputStyle.Short, 4, 32));
                            modal.AddComponents(new TextInputComponent("TOP REWARDS", Identity.EVENT_REWARD, text, embed.CustomData[Identity.EVENT_REWARD] as string, true, TextInputStyle.Paragraph, 0, 1024));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;
                        ...
                        case Identity.SELECTION_EVENT_TIMESTAMP:
                            ...
                            modal.AddComponents(new TextInputComponent("TITLE", Identity.EVENT_TIME_TITLE, text, embed.CustomData[Identity.EVENT_TIME_TITLE] as string, true, TextInputStyle.Short, 4, 32));
                            modal.AddComponents(new TextInputComponent("FORMAT START DATE", Identity.EVENT_DESCRIPTION_START, text, embed.CustomData[Identity.EVENT_DESCRIPTION_START] as string, false, TextInputStyle.Paragraph, 0, 128));
                            modal.AddComponents(new TextInputComponent("FORMAT END DATE", Identity.EVENT_DESCRIPTION_END, text, embed.CustomData[Identity.EVENT_DESCRIPTION_END] as string, false, TextInputStyle.Paragraph, 0, 128));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;
                        ...
                        case Identity.SELECTION_EVENT_REACTION:
                            ...
                            modal.AddComponents(new TextInputComponent("FORMAT REACTION TEXT", Identity.EVENT_DESCRIPTION_REACTION, text, embed.CustomData[Identity.EVENT_DESCRIPTION_REACTION] as string, false, TextInputStyle.Paragraph, 0, 1024));
                            await e.Interaction.CreateResponseAsync(InteractionResponseType.Modal, modal);
                            break;
